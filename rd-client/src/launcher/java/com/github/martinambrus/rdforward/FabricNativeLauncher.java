 ...
 * sets the library path and Fabric system properties, then launches via
 * Fabric Loader's KnotClient (which discovers our GameProvider and Mixins).
 */
public class FabricNativeLauncher {
    ...
    private static Path extractNatives() throws IOException, URISyntaxException {
        ...
        Path jarPath = Paths.get(FabricNativeLauncher.class
            .getProtectionDomain()
            .getCodeSource()
            .getLocation()
            .toURI());
