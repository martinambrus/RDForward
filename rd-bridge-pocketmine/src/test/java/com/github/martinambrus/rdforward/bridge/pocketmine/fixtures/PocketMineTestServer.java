...
/**
 * Minimal in-memory {@code Server} for the PocketMine bridge tests.
 * Only the pieces the bridge touches are implemented.
 */
public final class PocketMineTestServer implements Server {
