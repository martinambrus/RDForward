...
/**
 * Beta 1.7.3: tests inventory GUI open/close/click.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173InventoryManipulationTest*"
 */
class Beta173InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-inventory-manipulation-").toFile();
    ...
    @Test
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "inventory_manipulation")
