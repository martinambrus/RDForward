...
/**
 * Release 1.7.3: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release173ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release173-chat-test-").toFile();
    ...
    @Test
    void release173ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release173", "chat", 0.80)
