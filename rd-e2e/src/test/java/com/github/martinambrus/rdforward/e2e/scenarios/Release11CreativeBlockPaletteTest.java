...
/**
 * Release 1.1: Creative block palette test.
 ...
 */
class Release11CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release11-palette-").toFile();
    ...
    @Test
    void release11CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease11(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release11", "creative_block_palette")
