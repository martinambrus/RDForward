 ...
 * for Alpha 1.1.0.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110QDrop*"
 */
class Alpha110QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-qdrop-").toFile();
    ...
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "q_drop")
