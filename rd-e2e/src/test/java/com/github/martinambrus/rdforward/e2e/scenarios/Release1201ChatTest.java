...
/**
 * Release 1.20.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1201ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1201-chat-test-").toFile();
    ...
    @Test
    void release1201ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1201", "chat", 0.8)
