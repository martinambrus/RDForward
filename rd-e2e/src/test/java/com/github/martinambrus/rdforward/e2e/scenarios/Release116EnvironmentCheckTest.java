...
/**
 * Release 1.16: Verifies the spawn environment (creative mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release116EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release116-env-check-").toFile();
    ...
    @Test
    void release116EnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release116", "environment_check")
