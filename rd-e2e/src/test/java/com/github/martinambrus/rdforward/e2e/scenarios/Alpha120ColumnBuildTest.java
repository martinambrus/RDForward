 ...
 * for Alpha 1.2.0_02.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120Column*"
 */
class Alpha120ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-column-").toFile();
    ...
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "column_build")
