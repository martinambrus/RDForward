...
/**
 * Release 1.8.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release182ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release182-chat-test-").toFile();
    ...
    @Test
    void release182ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release182", "chat", 0.80)
