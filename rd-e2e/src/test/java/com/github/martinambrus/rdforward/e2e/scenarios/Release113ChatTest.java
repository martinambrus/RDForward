...
/**
 * Release 1.13: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release113ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release113-chat-test-").toFile();
    ...
    @Test
    void release113ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release113", "chat", 0.80)
