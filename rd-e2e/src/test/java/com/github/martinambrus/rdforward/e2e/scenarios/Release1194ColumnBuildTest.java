...
/**
 * Release 1.19.4: Tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1194ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1194-column-test-").toFile();
    ...
    @Test
    void release1194ColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1194", "column_build")
