 ...
 * replenishment for Alpha 1.1.0.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110BlockPlace*"
 */
class Alpha110BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "block_place_break")
