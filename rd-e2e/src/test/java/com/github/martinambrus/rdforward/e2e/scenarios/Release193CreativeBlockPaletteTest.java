...
/**
 * Release 1.9.3: Creative block palette test.
 ...
 */
class Release193CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release193-palette-").toFile();
    ...
    @Test
    void release193CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease193(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release193", "creative_block_palette")
