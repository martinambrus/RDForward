 ...
 * and confirming the server teleports back to spawn for Alpha 1.0.15.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015VoidFall*"
 */
class Alpha1015VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "void_fall", 0.85)
