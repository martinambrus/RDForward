...
/**
 * Release 1.8.3: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release183ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release183-chat-test-").toFile();
    ...
    @Test
    void release183ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release183", "chat", 0.80)
