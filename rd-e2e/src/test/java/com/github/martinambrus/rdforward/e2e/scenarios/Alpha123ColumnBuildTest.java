 ...
 * for Alpha 1.2.3_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123Column*"
 */
class Alpha123ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-column-").toFile();
    ...
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "column_build")
