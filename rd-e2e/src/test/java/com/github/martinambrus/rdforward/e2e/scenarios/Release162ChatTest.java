...
/**
 * Release 1.6.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release162ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release162-chat-test-").toFile();
    ...
    @Test
    void release162ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release162", "chat", 0.80)
