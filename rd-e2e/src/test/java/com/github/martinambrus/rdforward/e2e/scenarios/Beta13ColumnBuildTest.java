...
/**
 * Beta 1.3_01: tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13ColumnBuildTest*"
 */
class Beta13ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-column-build-").toFile();
    ...
    void betaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "column_build")
