...
/**
 * Beta 1.8.1: Tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class BetaColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta-column-test-").toFile();
    ...
    void betaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta181", "column_build")
