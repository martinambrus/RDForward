...
/**
 * E2E test: Alpha 1.0.15 client logs into RDForward, loads the world,
 * and verifies the agent reaches COMPLETE state.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015*"
 */
class Alpha1015LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-").toFile();
    ...
    void alphaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "world_loaded")
