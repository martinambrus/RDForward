 ...
 * for Alpha 1.2.2b.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122Column*"
 */
class Alpha122ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-column-").toFile();
    ...
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "column_build")
