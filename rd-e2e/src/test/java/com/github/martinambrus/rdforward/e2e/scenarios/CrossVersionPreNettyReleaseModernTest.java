...
/**
 * Pre-Netty Release as primary vs Modern secondaries (1.19+).
 */
class CrossVersionPreNettyReleaseModernTest extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.PRE_NETTY_RELEASE, Weight.MODERN);
    }
}
