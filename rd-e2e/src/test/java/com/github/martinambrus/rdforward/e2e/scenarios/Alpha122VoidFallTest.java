 ...
 * and confirming the server teleports back to spawn for Alpha 1.2.2b.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122VoidFall*"
 */
class Alpha122VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "void_fall", 0.85)
