...
/**
 * Release 1.6.4: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release164ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release164-chat-test-").toFile();
    ...
    @Test
    void release164ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release164", "chat", 0.80)
