...
/**
 * Verifies the spawn environment for Alpha 1.0.16: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1016Environment*"
 */
class Alpha1016EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1016-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchAlpha1016(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1016", "environment_check")
