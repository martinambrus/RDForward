...
/**
 * Release 1.10: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release110ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release110-chat-test-").toFile();
    ...
    @Test
    void release110ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release110", "chat", 0.80)
