...
/**
 * Tests inventory manipulation for Alpha 1.1.0: open GUI, click slots,
 * split stacks, drop items outside, and verify replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110Inventory*"
 */
class Alpha110InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-inventory-").toFile();
    ...
    void alphaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "inventory_manipulation")
