...
/**
 * Release 1.7.5: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release175ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release175-chat-test-").toFile();
    ...
    @Test
    void release175ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release175", "chat", 0.80)
