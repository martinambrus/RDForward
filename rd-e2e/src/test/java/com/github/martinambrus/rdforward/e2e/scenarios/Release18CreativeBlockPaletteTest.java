...
/**
 * Release 1.8: Creative block palette test.
 ...
 */
class Release18CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release18-palette-").toFile();
    ...
    @Test
    void release18CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease18(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release18", "creative_block_palette")
