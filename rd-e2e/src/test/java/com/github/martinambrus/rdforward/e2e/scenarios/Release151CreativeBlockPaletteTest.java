...
/**
 * Release 1.5.1: Creative block palette test.
 ...
 */
class Release151CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release151-palette-").toFile();
    ...
    @Test
    void release151CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease151(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release151", "creative_block_palette")
