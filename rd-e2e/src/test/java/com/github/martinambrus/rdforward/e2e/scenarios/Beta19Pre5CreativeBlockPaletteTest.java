...
/**
 * Beta 1.9 Pre-release 5: Creative block palette test.
 ...
 */
class Beta19Pre5CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-palette-").toFile();
    ...
    @Test
    void beta19Pre5CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchBeta19Pre5(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "creative_block_palette")
