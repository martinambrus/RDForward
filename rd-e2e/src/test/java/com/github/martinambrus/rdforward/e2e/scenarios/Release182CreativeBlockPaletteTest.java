...
/**
 * Release 1.8.2: Creative block palette test.
 ...
 */
class Release182CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release182-palette-").toFile();
    ...
    @Test
    void release182CreativeBlockPalettePasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release182", "creative_block_palette")
