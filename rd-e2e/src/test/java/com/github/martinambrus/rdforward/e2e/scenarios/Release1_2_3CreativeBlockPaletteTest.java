...
/**
 * Release 1.2.3: Creative block palette test.
 ...
 */
class Release1_2_3CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_3-palette-").toFile();
    ...
    @Test
    void release_1_2_3CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease1_2_3(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_3", "creative_block_palette")
