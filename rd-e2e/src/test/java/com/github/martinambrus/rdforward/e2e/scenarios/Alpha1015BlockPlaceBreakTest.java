 ...
 * replenishment for Alpha 1.0.15.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015BlockPlace*"
 */
class Alpha1015BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "block_place_break")
