...
/**
 * Release 1.15: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release115ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release115-chat-test-").toFile();
    ...
    @Test
    void release115ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release115", "chat", 0.80)
