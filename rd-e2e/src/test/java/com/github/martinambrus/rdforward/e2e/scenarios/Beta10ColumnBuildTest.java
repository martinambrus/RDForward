...
/**
 * Beta 1.0: tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta10ColumnBuildTest*"
 */
class Beta10ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta10-column-build-").toFile();
    ...
    void betaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta10", "column_build")
