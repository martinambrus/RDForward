...
/**
 * Beta 1.3_01: verifies the spawn environment (survival mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13EnvironmentCheckTest*"
 */
class Beta13EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-environment-check-").toFile();
    ...
    void betaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchBeta131(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "environment_check")
