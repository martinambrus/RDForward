...
/**
 * Release 1.11: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release111ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release111-chat-test-").toFile();
    ...
    @Test
    void release111ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release111", "chat", 0.80)
