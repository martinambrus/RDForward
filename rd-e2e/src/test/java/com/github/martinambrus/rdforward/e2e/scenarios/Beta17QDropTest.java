...
/**
 * Beta 1.7: tests Q-drop and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta17QDropTest*"
 */
class Beta17QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta17-q-drop-").toFile();
    ...
    void betaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta17", "q_drop")
