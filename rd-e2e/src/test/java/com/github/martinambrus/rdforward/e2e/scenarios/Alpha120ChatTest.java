 ...
 * for Alpha 1.2.0_02.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120Chat*"
 */
class Alpha120ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "chat", 0.80)
