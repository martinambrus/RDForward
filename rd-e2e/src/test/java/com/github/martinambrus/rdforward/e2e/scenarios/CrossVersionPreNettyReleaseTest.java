 ...
 * (Pre-Netty Release, Netty LWJGL2). Shard 1 of 2.
 */
class CrossVersionPreNettyReleaseTest extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategoryShard(
                Category.PRE_NETTY_RELEASE, Weight.LIGHT, 0, 2);
    }
}
