...
/**
 * Release 1.7.6: Creative block palette test.
 ...
 */
class Release176CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release176-palette-").toFile();
    ...
    @Test
    void release176CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease176(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release176", "creative_block_palette")
