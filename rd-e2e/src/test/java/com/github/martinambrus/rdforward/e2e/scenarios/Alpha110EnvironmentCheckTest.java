...
/**
 * Verifies the spawn environment for Alpha 1.1.0: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110Environment*"
 */
class Alpha110EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchAlpha110(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "environment_check")
