...
/**
 * Beta 1.5_01: tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta15ColumnBuildTest*"
 */
class Beta15ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta15-column-build-").toFile();
    ...
    void betaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta15", "column_build")
