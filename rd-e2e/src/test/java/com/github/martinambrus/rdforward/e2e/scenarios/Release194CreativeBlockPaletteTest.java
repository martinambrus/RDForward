...
/**
 * Release 1.9.4: Creative block palette test.
 ...
 */
class Release194CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release194-palette-").toFile();
    ...
    @Test
    void release194CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease194(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release194", "creative_block_palette")
