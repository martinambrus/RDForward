...
/**
 * Release 1.8.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release181ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release181-chat-test-").toFile();
    ...
    @Test
    void release181ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release181", "chat", 0.80)
