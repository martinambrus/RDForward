...
/**
 * Release 1.2.4: Creative block palette test.
 ...
 */
class Release1_2_4CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_4-palette-").toFile();
    ...
    @Test
    void release_1_2_4CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease1_2_4(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_4", "creative_block_palette")
