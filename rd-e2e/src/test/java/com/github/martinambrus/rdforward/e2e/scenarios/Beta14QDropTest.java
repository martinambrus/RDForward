...
/**
 * Beta 1.4_01: tests Q-drop and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14QDropTest*"
 */
class Beta14QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-q-drop-").toFile();
    ...
    void betaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "q_drop")
