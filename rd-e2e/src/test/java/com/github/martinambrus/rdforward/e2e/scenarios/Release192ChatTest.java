...
/**
 * Release 1.9.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release192ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release192-chat-test-").toFile();
    ...
    @Test
    void release192ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release192", "chat", 0.80)
