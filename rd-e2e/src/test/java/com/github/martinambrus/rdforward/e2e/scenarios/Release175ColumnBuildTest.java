...
/**
 * Release 1.7.5: Tests building a column to near max height
 * and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release175ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release175-column-test-").toFile();
    ...
    @Test
    void release175ColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release175", "column_build")
