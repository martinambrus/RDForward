...
/**
 * Beta 1.9 Pre-release 5: Tests walking to map edge, falling into void,
 * and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Beta19Pre5VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-void-fall-").toFile();
    ...
    @Test
    void beta19Pre5VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "void_fall", 0.85)
