...
/**
 * Release 1.7.4: Creative block palette test.
 ...
 */
class Release174CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release174-palette-").toFile();
    ...
    @Test
    void release174CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease174(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release174", "creative_block_palette")
