...
/**
 * Release 1.15.2: Tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1152VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1152-void-fall-").toFile();
    ...
    @Test
    void release1152VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1152", "void_fall", 0.85)
