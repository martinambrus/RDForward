...
/**
 * Release 1.9.2: Creative block palette test.
 ...
 */
class Release192CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release192-palette-").toFile();
    ...
    @Test
    void release192CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease192(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release192", "creative_block_palette")
