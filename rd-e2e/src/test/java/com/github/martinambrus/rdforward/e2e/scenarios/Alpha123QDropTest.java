 ...
 * for Alpha 1.2.3_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123QDrop*"
 */
class Alpha123QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-qdrop-").toFile();
    ...
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "q_drop")
