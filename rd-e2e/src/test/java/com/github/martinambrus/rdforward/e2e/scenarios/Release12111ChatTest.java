...
/**
 * Release 1.21.11: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release12111ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release12111-chat-test-").toFile();
    ...
    @Test
    void release12111ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release12111", "chat", 0.8)
