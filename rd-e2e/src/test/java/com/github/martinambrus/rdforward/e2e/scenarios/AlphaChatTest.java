 ...
 *
 * Run with: ./gradlew :rd-e2e:test --tests "*.AlphaChatTest" -Pe2e
 */
class AlphaChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-chat-test-").toFile();
    ...
    @Test
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            File screenshot = new File(statusDir, "chat_complete.png");
            assertTrue(screenshot.exists(), "Screenshot chat_complete.png not produced");
            assertTrue(screenshot.length() > 0, "Screenshot chat_complete.png is empty");
        } finally {
            if (client.isAlive()) {
