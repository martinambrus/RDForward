...
/**
 * Beta as primary vs all Light-weight secondaries (Beta, Pre-Netty Release,
 * Netty LWJGL2).
 */
class CrossVersionBetaTest extends CrossVersionMatrixTestBase {
