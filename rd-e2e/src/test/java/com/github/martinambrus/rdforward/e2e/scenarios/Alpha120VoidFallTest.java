 ...
 * and confirming the server teleports back to spawn for Alpha 1.2.0_02.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120VoidFall*"
 */
class Alpha120VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "void_fall", 0.85)
