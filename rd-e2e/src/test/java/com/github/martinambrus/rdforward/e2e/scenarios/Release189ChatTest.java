...
/**
 * Release 1.8.9: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release189ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release189-chat-test-").toFile();
    ...
    @Test
    void release189ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release189", "chat", 0.80)
