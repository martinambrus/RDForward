 ...
 * for Alpha 1.2.0_02.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120QDrop*"
 */
class Alpha120QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-qdrop-").toFile();
    ...
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "q_drop")
