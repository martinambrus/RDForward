...
/**
 * Release 1.8.1: Creative block palette test.
 ...
 */
class Release181CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release181-palette-").toFile();
    ...
    @Test
    void release181CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease181(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release181", "creative_block_palette")
