 ...
 * replenishment for Alpha 1.0.16.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1016BlockPlace*"
 */
class Alpha1016BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1016-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1016", "block_place_break")
