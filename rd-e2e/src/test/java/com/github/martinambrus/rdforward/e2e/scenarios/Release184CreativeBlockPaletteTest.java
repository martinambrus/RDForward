...
/**
 * Release 1.8.4: Creative block palette test.
 ...
 */
class Release184CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release184-palette-").toFile();
    ...
    @Test
    void release184CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease184(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release184", "creative_block_palette")
