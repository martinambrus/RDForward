...
/**
 * Release 1.7.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release172ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release172-chat-test-").toFile();
    ...
    @Test
    void release172ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release172", "chat", 0.80)
