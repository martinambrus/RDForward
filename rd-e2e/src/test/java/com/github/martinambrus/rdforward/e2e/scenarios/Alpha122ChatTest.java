 ...
 * for Alpha 1.2.2b.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122Chat*"
 */
class Alpha122ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "chat", 0.80)
