...
/**
 * Release 1.17.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1171ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1171-chat-test-").toFile();
    ...
    @Test
    void release1171ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1171", "chat", 0.80)
