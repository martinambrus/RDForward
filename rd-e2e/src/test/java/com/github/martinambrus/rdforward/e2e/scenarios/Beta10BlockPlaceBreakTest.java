...
/**
 * Beta 1.0: tests block breaking, placement, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta10BlockPlaceBreakTest*"
 */
class Beta10BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta10-block-place-break-").toFile();
    ...
    void betaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta10", "block_place_break")
