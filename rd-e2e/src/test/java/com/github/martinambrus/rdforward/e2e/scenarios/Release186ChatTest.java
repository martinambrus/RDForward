...
/**
 * Release 1.8.6: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release186ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release186-chat-test-").toFile();
    ...
    @Test
    void release186ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release186", "chat", 0.80)
