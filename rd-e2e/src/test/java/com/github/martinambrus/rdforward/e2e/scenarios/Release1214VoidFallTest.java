...
/**
 * Release 1.21.4: Tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1214VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1214-void-fall-").toFile();
    ...
    @Test
    void release1214VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1214", "void_fall", 0.85)
