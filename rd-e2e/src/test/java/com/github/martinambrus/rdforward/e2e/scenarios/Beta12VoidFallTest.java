...
/**
 * Beta 1.2_02: tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta12VoidFallTest*"
 */
class Beta12VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta12-void-fall-").toFile();
    ...
    void betaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta12", "void_fall", 0.85)
