 ...
 * and confirming the server teleports back to spawn for Alpha 1.0.17_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017VoidFall*"
 */
class Alpha1017VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-void-").toFile();
    ...
    @Test
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "void_fall", 0.85)
