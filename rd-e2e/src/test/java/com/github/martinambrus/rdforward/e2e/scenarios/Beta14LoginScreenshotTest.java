...
/**
 * Beta 1.4_01: logs into RDForward, loads the world, and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14LoginScreenshotTest*"
 */
class Beta14LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-world-loaded-").toFile();
    ...
    void betaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "world_loaded")
