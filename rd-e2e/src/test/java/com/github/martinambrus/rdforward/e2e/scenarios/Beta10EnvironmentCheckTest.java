...
/**
 * Beta 1.0: verifies the spawn environment (survival mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta10EnvironmentCheckTest*"
 */
class Beta10EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta10-environment-check-").toFile();
    ...
    void betaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchBeta10(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta10", "environment_check")
