...
/**
 * Beta 1.4_01: tests block breaking, placement, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14BlockPlaceBreakTest*"
 */
class Beta14BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-block-place-break-").toFile();
    ...
    void betaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "block_place_break")
