...
/**
 * Release 1.7.4: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release174ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release174-chat-test-").toFile();
    ...
    @Test
    void release174ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release174", "chat", 0.80)
