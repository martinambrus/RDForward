...
class Release112LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release112-").toFile();
    ...
    @Test
    void release112ClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release112", "world_loaded")
