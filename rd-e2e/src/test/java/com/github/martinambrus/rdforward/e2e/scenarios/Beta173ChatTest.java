...
/**
 * Beta 1.7.3: tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173ChatTest*"
 */
class Beta173ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-chat-").toFile();
    ...
    @Test
    void betaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "chat", 0.8)
