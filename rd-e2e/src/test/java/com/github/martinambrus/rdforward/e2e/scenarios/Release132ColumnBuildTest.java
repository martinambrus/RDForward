...
/**
 * Release 1.3.2: Tests building a column to near max height
 * and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release132ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release132-column-test-").toFile();
    ...
    @Test
    void release132ColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release132", "column_build")
