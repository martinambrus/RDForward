...
/**
 * Release 1.7.7: Creative block palette test.
 ...
 */
class Release177CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release177-palette-").toFile();
    ...
    @Test
    void release177CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease177(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release177", "creative_block_palette")
