 ...
 * for Alpha 1.0.17_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017Chat*"
 */
class Alpha1017ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "chat", 0.80)
