...
/**
 * Release 1.6.2: Creative block palette test.
 ...
 */
class Release162CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release162-palette-").toFile();
    ...
    @Test
    void release162CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease162(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release162", "creative_block_palette")
