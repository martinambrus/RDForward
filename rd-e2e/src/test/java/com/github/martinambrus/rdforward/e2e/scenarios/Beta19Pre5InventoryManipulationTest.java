...
/**
 * Beta 1.9 Pre-release 5: Tests inventory GUI open/close/click in creative mode.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Beta19Pre5InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-inv-test-").toFile();
    ...
    @Test
    void beta19Pre5InventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "inventory_manipulation")
