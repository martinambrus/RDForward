...
/**
 * Beta 1.2_02: tests block breaking, placement, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta12BlockPlaceBreakTest*"
 */
class Beta12BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta12-block-place-break-").toFile();
    ...
    void betaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta12", "block_place_break")
