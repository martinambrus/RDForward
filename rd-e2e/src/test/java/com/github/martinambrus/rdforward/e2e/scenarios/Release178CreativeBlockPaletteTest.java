...
/**
 * Release 1.7.8: Creative block palette test.
 ...
 */
class Release178CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release178-palette-").toFile();
    ...
    @Test
    void release178CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease178(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release178", "creative_block_palette")
