...
/**
 * Tests building a column to near max height and breaking back down
 * for Alpha 1.0.17_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017Column*"
 */
class Alpha1017ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-column-").toFile();
    ...
    @Test
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        Process client = launcher.launchAlpha1017(agentJar, server.getPort(),
                statusDir, display.getDisplay(), "column_build");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "column_build")
