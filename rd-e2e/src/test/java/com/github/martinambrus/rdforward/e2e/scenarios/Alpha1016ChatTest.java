 ...
 * for Alpha 1.0.16.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1016Chat*"
 */
class Alpha1016ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1016-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1016", "chat", 0.80)
