...
/**
 * Release 1.7.8: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release178ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release178-chat-test-").toFile();
    ...
    @Test
    void release178ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release178", "chat", 0.80)
