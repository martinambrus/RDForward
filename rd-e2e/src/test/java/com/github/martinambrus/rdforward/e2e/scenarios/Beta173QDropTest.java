...
/**
 * Beta 1.7.3: tests Q-drop and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173QDropTest*"
 */
class Beta173QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-q-drop-").toFile();
    ...
    @Test
    void betaQDropPasses() throws Exception {
        ...
        Process client = launcher.launchBeta173(agentJar, server.getPort(),
                statusDir, display.getDisplay(), "q_drop");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "q_drop")
