...
/**
 * Release 1.7.9: Creative block palette test.
 ...
 */
class Release179CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release179-palette-").toFile();
    ...
    @Test
    void release179CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease179(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release179", "creative_block_palette")
