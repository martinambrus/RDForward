...
/**
 * Beta 1.0: tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta10VoidFallTest*"
 */
class Beta10VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta10-void-fall-").toFile();
    ...
    void betaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta10", "void_fall", 0.85)
