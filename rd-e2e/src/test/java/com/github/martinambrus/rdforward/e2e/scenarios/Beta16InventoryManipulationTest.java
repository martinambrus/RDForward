...
/**
 * Beta 1.6: tests inventory GUI open/close/click.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta16InventoryManipulationTest*"
 */
class Beta16InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta16-inventory-manipulation-").toFile();
    ...
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta16", "inventory_manipulation")
