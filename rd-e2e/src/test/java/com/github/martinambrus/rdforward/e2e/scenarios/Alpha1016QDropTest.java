 ...
 * for Alpha 1.0.16.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1016QDrop*"
 */
class Alpha1016QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1016-qdrop-").toFile();
    ...
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1016", "q_drop")
