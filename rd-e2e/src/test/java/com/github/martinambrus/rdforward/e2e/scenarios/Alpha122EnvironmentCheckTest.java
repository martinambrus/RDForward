...
/**
 * Verifies the spawn environment for Alpha 1.2.2b: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122Environment*"
 */
class Alpha122EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchAlpha122(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "environment_check")
