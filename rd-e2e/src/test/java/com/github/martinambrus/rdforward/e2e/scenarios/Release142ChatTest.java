...
/**
 * Release 1.4.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release142ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release142-chat-test-").toFile();
    ...
    @Test
    void release142ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release142", "chat", 0.80)
