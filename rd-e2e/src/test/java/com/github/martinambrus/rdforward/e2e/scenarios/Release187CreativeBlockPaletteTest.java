...
/**
 * Release 1.8.7: Creative block palette test.
 ...
 */
class Release187CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release187-palette-").toFile();
    ...
    @Test
    void release187CreativeBlockPalettePasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release187", "creative_block_palette")
