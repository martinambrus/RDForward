...
/**
 * Release 1.8.5: Creative block palette test.
 ...
 */
class Release185CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release185-palette-").toFile();
    ...
    @Test
    void release185CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease185(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release185", "creative_block_palette")
