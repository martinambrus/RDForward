...
/**
 * Release 1.2.5: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1_2_5ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_5-chat-test-").toFile();
    ...
    @Test
    void release_1_2_5ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_5", "chat", 0.80)
