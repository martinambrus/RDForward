...
/**
 * Beta 1.7: tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta17ChatTest*"
 */
class Beta17ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta17-chat-").toFile();
    ...
    void betaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta17", "chat", 0.8)
