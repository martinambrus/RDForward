...
/**
 * Beta 1.2_02: tests inventory GUI open/close/click.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta12InventoryManipulationTest*"
 */
class Beta12InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta12-inventory-manipulation-").toFile();
    ...
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta12", "inventory_manipulation")
