...
/**
 * Beta 1.7: logs into RDForward, loads the world, and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta17LoginScreenshotTest*"
 */
class Beta17LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta17-world-loaded-").toFile();
    ...
    void betaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta17", "world_loaded")
