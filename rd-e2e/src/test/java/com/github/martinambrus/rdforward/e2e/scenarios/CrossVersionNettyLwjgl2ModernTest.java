...
/**
 * Netty LWJGL2 as primary vs Modern secondaries (1.19+).
 */
class CrossVersionNettyLwjgl2ModernTest extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.NETTY_LWJGL2, Weight.MODERN);
    }
}
