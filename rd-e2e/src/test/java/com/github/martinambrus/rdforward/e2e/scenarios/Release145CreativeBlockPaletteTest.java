...
/**
 * Release 1.4.5: Creative block palette test.
 ...
 */
class Release145CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release145-palette-").toFile();
    ...
    @Test
    void release145CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease145(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release145", "creative_block_palette")
