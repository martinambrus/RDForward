...
/**
 * Release 1.21.10: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release12110ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release12110-chat-test-").toFile();
    ...
    @Test
    void release12110ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release12110", "chat", 0.8)
