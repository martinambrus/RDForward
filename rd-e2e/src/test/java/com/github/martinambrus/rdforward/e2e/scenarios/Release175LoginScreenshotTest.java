...
class Release175LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release175-").toFile();
    ...
    @Test
    void release175ClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release175", "world_loaded")
