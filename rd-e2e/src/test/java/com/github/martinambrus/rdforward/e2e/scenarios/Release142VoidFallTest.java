...
/**
 * Release 1.4.2: Tests walking to map edge, falling into void,
 * and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release142VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release142-void-fall-").toFile();
    ...
    @Test
    void release142VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release142", "void_fall", 0.85)
