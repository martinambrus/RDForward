...
/**
 * Beta 1.2_02: tests Q-drop and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta12QDropTest*"
 */
class Beta12QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta12-q-drop-").toFile();
    ...
    void betaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta12", "q_drop")
