...
/**
 * Beta 1.9 Pre-release 5: Tests block breaking, placement, and creative mode replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Beta19Pre5BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-block-test-").toFile();
    ...
    @Test
    void beta19Pre5BlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "block_place_break")
