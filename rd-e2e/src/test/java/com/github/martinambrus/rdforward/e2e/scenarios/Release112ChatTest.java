...
/**
 * Release 1.12: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release112ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release112-chat-test-").toFile();
    ...
    @Test
    void release112ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release112", "chat", 0.80)
