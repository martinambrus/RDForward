...
class RubyDungEnvironmentCheckTest {
    ...
    @Test
    void rubyDungEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchModdedClient(
                ...
                "E2EBot", statusDir, display.getDisplay(), "environment_check");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("rubydung", "environment_check")
