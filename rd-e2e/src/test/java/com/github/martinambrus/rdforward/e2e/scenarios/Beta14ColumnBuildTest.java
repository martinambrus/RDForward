...
/**
 * Beta 1.4_01: tests building a column to near max height and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14ColumnBuildTest*"
 */
class Beta14ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-column-build-").toFile();
    ...
    void betaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "column_build")
