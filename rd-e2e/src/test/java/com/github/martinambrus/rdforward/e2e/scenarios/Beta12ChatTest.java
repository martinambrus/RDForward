...
/**
 * Beta 1.2_02: tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta12ChatTest*"
 */
class Beta12ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta12-chat-").toFile();
    ...
    void betaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta12", "chat", 0.8)
