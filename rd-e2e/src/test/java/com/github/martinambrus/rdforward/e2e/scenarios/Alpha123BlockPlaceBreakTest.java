 ...
 * replenishment for Alpha 1.2.3_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123BlockPlace*"
 */
class Alpha123BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "block_place_break")
