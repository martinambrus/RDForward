...
/**
 * Release 1.16.2: client logs into RDForward, loads the world (creative mode), and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1162LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1162-").toFile();
    ...
    @Test
    void release1162ClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1162", "world_loaded")
