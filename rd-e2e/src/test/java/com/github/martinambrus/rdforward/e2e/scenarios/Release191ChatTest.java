...
/**
 * Release 1.9.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release191ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release191-chat-test-").toFile();
    ...
    @Test
    void release191ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release191", "chat", 0.80)
