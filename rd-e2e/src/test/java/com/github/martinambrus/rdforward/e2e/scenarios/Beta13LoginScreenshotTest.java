...
/**
 * Beta 1.3_01: logs into RDForward, loads the world, and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13LoginScreenshotTest*"
 */
class Beta13LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-world-loaded-").toFile();
    ...
    void betaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "world_loaded")
