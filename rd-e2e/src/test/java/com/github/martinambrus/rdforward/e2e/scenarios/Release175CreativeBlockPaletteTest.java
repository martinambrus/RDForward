...
/**
 * Release 1.7.5: Creative block palette test.
 ...
 */
class Release175CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release175-palette-").toFile();
    ...
    @Test
    void release175CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease175(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release175", "creative_block_palette")
