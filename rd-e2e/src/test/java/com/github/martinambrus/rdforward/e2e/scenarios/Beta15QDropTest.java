...
/**
 * Beta 1.5_01: tests Q-drop and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta15QDropTest*"
 */
class Beta15QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta15-q-drop-").toFile();
    ...
    void betaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta15", "q_drop")
