...
/**
 * Verifies the spawn environment: player on grass, clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class AlphaEnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-env-check-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            File screenshot = new File(statusDir, "environment_check.png");
            assertTrue(screenshot.exists(), "Screenshot not produced");
