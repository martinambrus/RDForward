...
/**
 * Release 1.8.7: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release187ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release187-chat-test-").toFile();
    ...
    @Test
    void release187ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release187", "chat", 0.80)
