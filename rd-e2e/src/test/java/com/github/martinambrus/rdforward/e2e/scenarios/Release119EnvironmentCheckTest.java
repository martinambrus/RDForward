...
/**
 * Release 1.19: Verifies the spawn environment (creative mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release119EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release119-env-check-").toFile();
    ...
    @Test
    void release119EnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release119", "environment_check")
