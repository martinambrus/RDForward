 ...
 * for Alpha 1.0.15.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015Chat*"
 */
class Alpha1015ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "chat", 0.80)
