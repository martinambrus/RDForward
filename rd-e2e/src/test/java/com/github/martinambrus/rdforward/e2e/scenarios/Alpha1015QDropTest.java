 ...
 * for Alpha 1.0.15.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015QDrop*"
 */
class Alpha1015QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-qdrop-").toFile();
    ...
    @Test
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "q_drop")
