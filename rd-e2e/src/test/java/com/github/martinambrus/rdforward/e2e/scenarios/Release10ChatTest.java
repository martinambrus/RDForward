...
/**
 * Release 1.0: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release10ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release10-chat-test-").toFile();
    ...
    @Test
    void release10ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release10", "chat", 0.80)
