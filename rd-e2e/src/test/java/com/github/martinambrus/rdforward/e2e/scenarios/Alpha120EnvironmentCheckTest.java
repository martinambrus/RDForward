...
/**
 * Verifies the spawn environment for Alpha 1.2.0_02: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120Environment*"
 */
class Alpha120EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchAlpha120(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "environment_check")
