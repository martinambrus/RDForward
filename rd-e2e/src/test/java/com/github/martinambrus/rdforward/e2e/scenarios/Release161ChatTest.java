...
/**
 * Release 1.6.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release161ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release161-chat-test-").toFile();
    ...
    @Test
    void release161ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release161", "chat", 0.80)
