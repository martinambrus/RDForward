...
/**
 * Beta 1.8.1: Tests inventory GUI open/close/click in creative mode.
 * Uses simplified creative step list (open, click empty, close, screenshot).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class BetaInventoryManipulationTest {
    ...
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            File screenshot = new File(statusDir, "inventory_complete.png");
            assertTrue(screenshot.exists(), "Screenshot inventory_complete.png not produced");
