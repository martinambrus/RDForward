...
/**
 * Release 1.21.10: client logs into RDForward, loads the world (creative mode), and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release12110LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release12110-").toFile();
    ...
    @Test
    void release12110ClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release12110", "world_loaded")
