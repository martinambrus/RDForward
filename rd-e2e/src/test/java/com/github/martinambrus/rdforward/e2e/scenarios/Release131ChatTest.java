...
/**
 * Release 1.3.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release131ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release131-chat-test-").toFile();
    ...
    @Test
    void release131ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release131", "chat", 0.80)
