...
/**
 * Beta 1.7: tests inventory GUI open/close/click.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta17InventoryManipulationTest*"
 */
class Beta17InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta17-inventory-manipulation-").toFile();
    ...
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta17", "inventory_manipulation")
