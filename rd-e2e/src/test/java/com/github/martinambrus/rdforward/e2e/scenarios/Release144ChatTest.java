...
/**
 * Release 1.4.4: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release144ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release144-chat-test-").toFile();
    ...
    @Test
    void release144ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release144", "chat", 0.80)
