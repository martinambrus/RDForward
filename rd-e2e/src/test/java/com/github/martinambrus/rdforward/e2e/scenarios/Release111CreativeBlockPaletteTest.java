...
/**
 * Release 1.11: Creative block palette test.
 ...
 */
class Release111CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release111-palette-").toFile();
    ...
    @Test
    void release111CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease111(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release111", "creative_block_palette")
