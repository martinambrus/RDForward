...
/**
 * Beta 1.9 Pre-release 5: Tests Q-drop and cobblestone replenishment in creative mode.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Beta19Pre5QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-qdrop-test-").toFile();
    ...
    @Test
    void beta19Pre5QDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "q_drop")
