 ...
 * replenishment for Alpha 1.2.2b.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122BlockPlace*"
 */
class Alpha122BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "block_place_break")
