...
/**
 * Cross-RD light pairs shard 2 of 3.
 */
class CrossVersionRdLightShard2Test extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.rdPairsByWeightShard(Weight.LIGHT, 1, 3);
    }
}
