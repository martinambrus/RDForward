...
/**
 * Release 1.16: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release116ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release116-chat-test-").toFile();
    ...
    @Test
    void release116ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release116", "chat", 0.80)
