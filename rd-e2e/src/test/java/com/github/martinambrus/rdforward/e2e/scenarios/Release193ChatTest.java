...
/**
 * Release 1.9.3: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release193ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release193-chat-test-").toFile();
    ...
    @Test
    void release193ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release193", "chat", 0.80)
