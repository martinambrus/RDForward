...
/**
 * Release 1.20: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release120ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release120-chat-test-").toFile();
    ...
    @Test
    void release120ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release120", "chat", 0.8)
