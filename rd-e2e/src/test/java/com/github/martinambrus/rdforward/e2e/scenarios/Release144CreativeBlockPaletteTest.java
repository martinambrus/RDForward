...
/**
 * Release 1.4.4: Creative block palette test.
 ...
 */
class Release144CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release144-palette-").toFile();
    ...
    @Test
    void release144CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease144(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release144", "creative_block_palette")
