...
/**
 * Verifies the spawn environment for Alpha 1.0.15: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015Environment*"
 */
class Alpha1015EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchAlpha1015(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "environment_check")
