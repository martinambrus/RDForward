...
/**
 * Beta 1.3_01: tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13ChatTest*"
 */
class Beta13ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-chat-").toFile();
    ...
    void betaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "chat", 0.8)
