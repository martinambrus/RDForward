...
/**
 * Release 1.7.3: Creative block palette test.
 ...
 */
class Release173CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release173-palette-").toFile();
    ...
    @Test
    void release173CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease173(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release173", "creative_block_palette")
