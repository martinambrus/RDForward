...
/**
 * Release 1.2.4: Tests walking to map edge, falling into void,
 * and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1_2_4VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_4-void-fall-").toFile();
    ...
    @Test
    void release_1_2_4VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_4", "void_fall", 0.85)
