...
/**
 * Release 1.7.6: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release176ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release176-chat-test-").toFile();
    ...
    @Test
    void release176ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release176", "chat", 0.80)
