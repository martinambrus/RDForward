...
/**
 * Release 1.4.7: Creative block palette test.
 ...
 */
class Release147CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release147-palette-").toFile();
    ...
    @Test
    void release147CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease147(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release147", "creative_block_palette")
