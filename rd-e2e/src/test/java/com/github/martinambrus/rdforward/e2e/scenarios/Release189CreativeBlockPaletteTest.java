...
/**
 * Release 1.8.9: Creative block palette test.
 ...
 */
class Release189CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release189-palette-").toFile();
    ...
    @Test
    void release189CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease189(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release189", "creative_block_palette")
