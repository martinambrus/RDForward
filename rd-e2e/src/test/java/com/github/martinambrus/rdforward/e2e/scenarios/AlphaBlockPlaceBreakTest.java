...
/**
 * Tests block breaking, placement, grass conversion, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class AlphaBlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-block-test-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha126", "block_place_break")
