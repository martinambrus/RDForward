...
/**
 * Release 1.8.8: Verifies the spawn environment (creative mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release188EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release188-env-check-").toFile();
    ...
    @Test
    void release188EnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release188", "environment_check")
