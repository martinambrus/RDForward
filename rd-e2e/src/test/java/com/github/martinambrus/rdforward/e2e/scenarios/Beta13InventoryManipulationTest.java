...
/**
 * Beta 1.3_01: tests inventory GUI open/close/click.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13InventoryManipulationTest*"
 */
class Beta13InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-inventory-manipulation-").toFile();
    ...
    void betaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "inventory_manipulation")
