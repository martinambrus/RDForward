...
/**
 * Beta 1.8.1: Tests Q-drop and cobblestone replenishment in creative mode.
 *
...
class BetaQDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta-qdrop-test-").toFile();
    ...
    void betaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta181", "q_drop")
