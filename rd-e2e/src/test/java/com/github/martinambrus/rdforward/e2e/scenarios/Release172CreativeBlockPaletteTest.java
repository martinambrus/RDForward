...
/**
 * Release 1.7.2: Creative block palette test.
 ...
 */
class Release172CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release172-palette-").toFile();
    ...
    @Test
    void release172CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease172(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release172", "creative_block_palette")
