 ...
 * replenishment for Alpha 1.2.0_02.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha120BlockPlace*"
 */
class Alpha120BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha120-block-").toFile();
    ...
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha120", "block_place_break")
