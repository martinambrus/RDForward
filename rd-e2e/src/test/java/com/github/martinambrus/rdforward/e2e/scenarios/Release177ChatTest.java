...
/**
 * Release 1.7.7: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release177ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release177-chat-test-").toFile();
    ...
    @Test
    void release177ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release177", "chat", 0.80)
