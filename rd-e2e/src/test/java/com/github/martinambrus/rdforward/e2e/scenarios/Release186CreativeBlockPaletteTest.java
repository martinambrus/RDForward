...
/**
 * Release 1.8.6: Creative block palette test.
 ...
 */
class Release186CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release186-palette-").toFile();
    ...
    @Test
    void release186CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease186(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release186", "creative_block_palette")
