...
/**
 * Release 1.12: Creative block palette test.
 ...
 */
class Release112CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release112-palette-").toFile();
    ...
    @Test
    void release112CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease112(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release112", "creative_block_palette")
