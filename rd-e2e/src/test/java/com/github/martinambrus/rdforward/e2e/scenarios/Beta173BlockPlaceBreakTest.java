...
/**
 * Beta 1.7.3: tests block breaking, placement, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173BlockPlaceBreakTest*"
 */
class Beta173BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-block-place-break-").toFile();
    ...
    @Test
    void betaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "block_place_break")
