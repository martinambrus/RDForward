...
/**
 * Release 1.4.6: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release146ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release146-chat-test-").toFile();
    ...
    @Test
    void release146ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release146", "chat", 0.80)
