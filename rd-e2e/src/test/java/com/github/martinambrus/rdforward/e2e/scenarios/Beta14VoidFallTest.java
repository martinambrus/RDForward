...
/**
 * Beta 1.4_01: tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14VoidFallTest*"
 */
class Beta14VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-void-fall-").toFile();
    ...
    void betaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "void_fall", 0.85)
