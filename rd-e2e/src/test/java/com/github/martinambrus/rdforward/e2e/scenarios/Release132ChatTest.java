...
/**
 * Release 1.3.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release132ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release132-chat-test-").toFile();
    ...
    @Test
    void release132ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release132", "chat", 0.80)
