...
/**
 * Release 1.5.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release151ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release151-chat-test-").toFile();
    ...
    @Test
    void release151ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release151", "chat", 0.80)
