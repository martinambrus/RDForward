...
/**
 * Release 1.8.8: Creative block palette test.
 ...
 */
class Release188CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release188-palette-").toFile();
    ...
    @Test
    void release188CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease188(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release188", "creative_block_palette")
