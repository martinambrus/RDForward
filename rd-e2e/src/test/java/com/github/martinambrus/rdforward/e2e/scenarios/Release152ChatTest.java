...
/**
 * Release 1.5.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release152ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release152-chat-test-").toFile();
    ...
    @Test
    void release152ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release152", "chat", 0.80)
