...
/**
 * Beta 1.0: tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta10ChatTest*"
 */
class Beta10ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta10-chat-").toFile();
    ...
    void betaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta10", "chat", 0.8)
