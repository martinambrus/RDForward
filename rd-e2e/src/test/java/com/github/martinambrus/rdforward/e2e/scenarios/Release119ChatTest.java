...
/**
 * Release 1.19: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release119ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release119-chat-test-").toFile();
    ...
    @Test
    void release119ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release119", "chat", 0.8)
