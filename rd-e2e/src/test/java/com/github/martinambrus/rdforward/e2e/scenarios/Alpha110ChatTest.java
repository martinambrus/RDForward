 ...
 * for Alpha 1.1.0.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110Chat*"
 */
class Alpha110ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "chat", 0.80)
