 ...
 * for Alpha 1.0.15.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015Column*"
 */
class Alpha1015ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-column-").toFile();
    ...
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "column_build")
