...
/**
 * Release 1.4.5: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release145ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release145-chat-test-").toFile();
    ...
    @Test
    void release145ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release145", "chat", 0.80)
