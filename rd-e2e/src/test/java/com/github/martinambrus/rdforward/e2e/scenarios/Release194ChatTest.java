...
/**
 * Release 1.9.4: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release194ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release194-chat-test-").toFile();
    ...
    @Test
    void release194ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release194", "chat", 0.80)
