...
/**
 * Release 1.6.4: Creative block palette test.
 ...
 */
class Release164CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release164-palette-").toFile();
    ...
    @Test
    void release164CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease164(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release164", "creative_block_palette")
