...
/**
 * Beta 1.7.3: logs into RDForward, loads the world, and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173LoginScreenshotTest*"
 */
class Beta173LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-world-loaded-").toFile();
    ...
    void betaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        Process client = launcher.launchBeta173(agentJar, server.getPort(),
                statusDir, display.getDisplay(), "world_loaded");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "world_loaded")
