...
/**
 * Release 1.14.4: Tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1144VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1144-void-fall-").toFile();
    ...
    @Test
    void release1144VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1144", "void_fall", 0.85)
