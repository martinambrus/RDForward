...
/**
 * Release 1.9: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release19ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release19-chat-test-").toFile();
    ...
    @Test
    void release19ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release19", "chat", 0.80)
