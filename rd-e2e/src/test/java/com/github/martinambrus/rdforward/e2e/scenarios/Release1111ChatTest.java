...
/**
 * Release 1.11.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1111ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1111-chat-test-").toFile();
    ...
    @Test
    void release1111ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1111", "chat", 0.80)
