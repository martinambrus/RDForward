...
/**
 * Release 1.5.2: Creative block palette test.
 ...
 */
class Release152CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release152-palette-").toFile();
    ...
    @Test
    void release152CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease152(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release152", "creative_block_palette")
