...
/**
 * E2E test: Alpha 1.2.2b client logs into RDForward, loads the world,
 * and verifies the agent reaches COMPLETE state.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122*"
 */
class Alpha122LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-").toFile();
    ...
    void alphaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "world_loaded")
