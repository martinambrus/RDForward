...
/**
 * Beta 1.9 Pre-release 5: Verifies the spawn environment (creative mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Beta19Pre5EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta19pre5-env-check-").toFile();
    ...
    @Test
    void beta19Pre5EnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta19pre5", "environment_check")
