...
/**
 * Release 1.9: Creative block palette test.
 ...
 */
class Release19CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release19-palette-").toFile();
    ...
    @Test
    void release19CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease19(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release19", "creative_block_palette")
