 ...
 * for Alpha 1.2.3_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123Chat*"
 */
class Alpha123ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-chat-").toFile();
    ...
    void alphaChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "chat", 0.80)
