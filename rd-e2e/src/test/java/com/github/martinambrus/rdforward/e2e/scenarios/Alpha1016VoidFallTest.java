 ...
 * and confirming the server teleports back to spawn for Alpha 1.0.16.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1016VoidFall*"
 */
class Alpha1016VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1016-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1016", "void_fall", 0.85)
