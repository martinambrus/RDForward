...
/**
 * Release 1.8.5: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release185ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release185-chat-test-").toFile();
    ...
    @Test
    void release185ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release185", "chat", 0.80)
