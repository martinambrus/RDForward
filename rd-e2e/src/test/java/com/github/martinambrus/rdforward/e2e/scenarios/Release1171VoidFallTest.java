...
/**
 * Release 1.17.1: Tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1171VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1171-void-fall-").toFile();
    ...
    @Test
    void release1171VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1171", "void_fall", 0.85)
