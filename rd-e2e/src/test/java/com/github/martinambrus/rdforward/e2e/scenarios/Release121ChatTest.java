...
/**
 * Release 1.21: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release121ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release121-chat-test-").toFile();
    ...
    @Test
    void release121ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release121", "chat", 0.8)
