...
/**
 * Tests block breaking, placement, grass conversion, and cobblestone
 * replenishment for Alpha 1.0.17_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017BlockPlace*"
 */
class Alpha1017BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-block-").toFile();
    ...
    @Test
    void alphaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "block_place_break")
