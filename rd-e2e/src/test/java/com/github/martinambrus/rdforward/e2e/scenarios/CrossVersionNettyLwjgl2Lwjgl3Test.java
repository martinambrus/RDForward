...
/**
 * Netty LWJGL2 as primary vs LWJGL3 secondaries (1.13-1.18.2).
 */
class CrossVersionNettyLwjgl2Lwjgl3Test extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.NETTY_LWJGL2, Weight.LWJGL3);
    }
}
