...
/**
 * Beta 1.4_01: verifies the spawn environment (survival mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta14EnvironmentCheckTest*"
 */
class Beta14EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta14-environment-check-").toFile();
    ...
    void betaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchBeta141(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta14", "environment_check")
