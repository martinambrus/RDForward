...
/**
 * Release 1.8: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release18ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release18-chat-test-").toFile();
    ...
    @Test
    void release18ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release18", "chat", 0.80)
