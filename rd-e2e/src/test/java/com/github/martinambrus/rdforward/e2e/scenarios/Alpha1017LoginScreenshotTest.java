...
/**
 * E2E test: Alpha 1.0.17_04 client logs into RDForward, loads the world,
 * and verifies the agent reaches COMPLETE state.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017*"
 */
class Alpha1017LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-").toFile();
    ...
    void alphaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "world_loaded")
