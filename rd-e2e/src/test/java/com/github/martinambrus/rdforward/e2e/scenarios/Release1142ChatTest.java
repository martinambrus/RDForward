...
/**
 * Release 1.14.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1142ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1142-chat-test-").toFile();
    ...
    @Test
    void release1142ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1142", "chat", 0.80)
