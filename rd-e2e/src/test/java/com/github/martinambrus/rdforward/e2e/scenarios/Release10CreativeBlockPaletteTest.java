...
/**
 * Release 1.0: Creative block palette test.
 ...
 */
class Release10CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release10-palette-").toFile();
    ...
    @Test
    void release10CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease10(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release10", "creative_block_palette")
