 ...
 * and confirming the server teleports back to spawn for Alpha 1.1.0.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110VoidFall*"
 */
class Alpha110VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "void_fall", 0.85)
