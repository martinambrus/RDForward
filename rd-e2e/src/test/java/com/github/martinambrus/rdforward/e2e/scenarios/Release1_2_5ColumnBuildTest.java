...
/**
 * Release 1.2.5: Tests building a column to near max height
 * and breaking back down.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1_2_5ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_5-column-test-").toFile();
    ...
    @Test
    void release_1_2_5ColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_5", "column_build")
