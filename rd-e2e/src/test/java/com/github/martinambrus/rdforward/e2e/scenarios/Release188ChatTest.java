...
/**
 * Release 1.8.8: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release188ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release188-chat-test-").toFile();
    ...
    @Test
    void release188ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release188", "chat", 0.80)
