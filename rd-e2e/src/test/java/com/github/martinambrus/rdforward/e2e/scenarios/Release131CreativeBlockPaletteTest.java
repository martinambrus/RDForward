...
/**
 * Release 1.3.1: Creative block palette test.
 ...
 */
class Release131CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release131-palette-").toFile();
    ...
    @Test
    void release131CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease131(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release131", "creative_block_palette")
