...
/**
 * Release 1.6.1: Creative block palette test.
 ...
 */
class Release161CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release161-palette-").toFile();
    ...
    @Test
    void release161CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease161(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release161", "creative_block_palette")
