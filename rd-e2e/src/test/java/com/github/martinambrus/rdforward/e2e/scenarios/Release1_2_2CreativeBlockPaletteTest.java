...
/**
 * Release 1.2.2: Creative block palette test.
 ...
 */
class Release1_2_2CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release_1_2_2-palette-").toFile();
    ...
    @Test
    void release_1_2_2CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease1_2_2(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release_1_2_2", "creative_block_palette")
