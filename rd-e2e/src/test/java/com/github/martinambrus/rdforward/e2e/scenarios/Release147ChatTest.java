...
/**
 * Release 1.4.7: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release147ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release147-chat-test-").toFile();
    ...
    @Test
    void release147ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release147", "chat", 0.80)
