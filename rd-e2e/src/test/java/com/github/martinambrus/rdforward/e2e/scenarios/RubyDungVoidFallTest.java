...
class RubyDungVoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-rd-void-fall-").toFile();
    ...
    @Test
    void rubyDungVoidFallPasses() throws Exception {
        ...
        Process client = launcher.launchModdedClient(
                ...
                "E2EBot", statusDir, display.getDisplay(), "void_fall");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("rubydung", "void_fall", 0.85)
