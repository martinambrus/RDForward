...
/**
 * Pre-Netty Release as primary vs LWJGL3 secondaries (1.13-1.18.2).
 */
class CrossVersionPreNettyReleaseLwjgl3Test extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.PRE_NETTY_RELEASE, Weight.LWJGL3);
    }
}
