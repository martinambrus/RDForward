...
/**
 * Release 1.4.4: Verifies the spawn environment (creative mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release144EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release144-env-check-").toFile();
    ...
    @Test
    void release144EnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release144", "environment_check")
