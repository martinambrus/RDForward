...
/**
 * Release 1.3.2: Creative block palette test.
 ...
 */
class Release132CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release132-palette-").toFile();
    ...
    @Test
    void release132CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease132(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release132", "creative_block_palette")
