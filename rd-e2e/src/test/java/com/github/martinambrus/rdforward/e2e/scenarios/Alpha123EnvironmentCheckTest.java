...
/**
 * Verifies the spawn environment for Alpha 1.2.3_04: player on grass,
 * clear surroundings, 64 cobblestone.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123Environment*"
 */
class Alpha123EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-env-").toFile();
    ...
    void alphaEnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "environment_check")
