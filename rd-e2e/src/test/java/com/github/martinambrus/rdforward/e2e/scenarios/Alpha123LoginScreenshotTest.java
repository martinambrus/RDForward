...
/**
 * E2E test: Alpha 1.2.3_04 client logs into RDForward, loads the world,
 * and verifies the agent reaches COMPLETE state.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123*"
 */
class Alpha123LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-").toFile();
    ...
    void alphaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "world_loaded")
