...
/**
 * Release 1.8.4: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release184ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release184-chat-test-").toFile();
    ...
    @Test
    void release184ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release184", "chat", 0.80)
