...
/**
 * Release 1.7.9: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release179ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release179-chat-test-").toFile();
    ...
    @Test
    void release179ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release179", "chat", 0.80)
