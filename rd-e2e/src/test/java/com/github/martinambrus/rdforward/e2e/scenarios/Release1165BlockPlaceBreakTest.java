...
/**
 * Release 1.16.5: Tests block breaking, placement, and creative mode replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1165BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1165-block-test-").toFile();
    ...
    @Test
    void release1165BlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1165", "block_place_break")
