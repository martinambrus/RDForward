...
/**
 * Tests inventory manipulation for Alpha 1.2.2b: open GUI, click slots,
 * split stacks, drop items outside, and verify replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122Inventory*"
 */
class Alpha122InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-inventory-").toFile();
    ...
    void alphaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "inventory_manipulation")
