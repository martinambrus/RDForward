...
/**
 * Release 1.10: Creative block palette test.
 ...
 */
class Release110CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release110-palette-").toFile();
    ...
    @Test
    void release110CreativeBlockPalettePasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release110", "creative_block_palette")
