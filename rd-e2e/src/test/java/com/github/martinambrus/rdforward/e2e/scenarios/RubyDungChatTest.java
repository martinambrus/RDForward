...
class RubyDungChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-rd-chat-").toFile();
    ...
    @Test
    void rubyDungChatPasses() throws Exception {
        ...
        Process client = launcher.launchModdedClient(
                ...
                "E2EBot", statusDir, display.getDisplay(), "chat");
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("rubydung", "chat", 0.80)
