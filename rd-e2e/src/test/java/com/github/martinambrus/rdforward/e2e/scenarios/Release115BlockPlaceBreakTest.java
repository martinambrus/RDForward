...
/**
 * Release 1.15: Tests block breaking, placement, and creative mode replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release115BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release115-block-test-").toFile();
    ...
    @Test
    void release115BlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release115", "block_place_break")
