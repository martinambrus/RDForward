...
/**
 * LWJGL3 as primary vs LWJGL3 secondaries (1.13-1.18.2 vs 1.13-1.18.2).
 */
class CrossVersionLwjgl3SelfTest extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.NETTY_LWJGL3, Weight.LWJGL3);
    }
}
