...
/**
 * Netty LWJGL2 as primary vs all Light-weight secondaries (Netty LWJGL2 only,
 * since all lighter categories are covered by their own primary test classes).
 */
class CrossVersionNettyLwjgl2Test extends CrossVersionMatrixTestBase {
    ...
    static Stream<Arguments> pairs() {
        return CrossVersionRegistry.nonRdPairsByPrimaryCategory(
                Category.NETTY_LWJGL2, Weight.LIGHT);
    }
}
