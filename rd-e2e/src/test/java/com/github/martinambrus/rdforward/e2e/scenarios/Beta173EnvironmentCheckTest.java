...
/**
 * Beta 1.7.3: verifies the spawn environment (survival mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta173EnvironmentCheckTest*"
 */
class Beta173EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta173-environment-check-").toFile();
    ...
    void betaEnvironmentCheckPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta173", "environment_check")
