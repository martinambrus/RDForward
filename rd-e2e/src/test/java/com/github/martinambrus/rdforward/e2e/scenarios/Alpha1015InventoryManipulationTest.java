...
/**
 * Tests inventory manipulation for Alpha 1.0.15: open GUI, click slots,
 * split stacks, drop items outside, and verify replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1015Inventory*"
 */
class Alpha1015InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1015-inventory-").toFile();
    ...
    void alphaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1015", "inventory_manipulation")
