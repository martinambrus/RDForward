...
/**
 * Tests inventory manipulation for Alpha 1.0.17_04: open GUI, click slots,
 * split stacks, drop items outside, and verify replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha1017Inventory*"
 */
class Alpha1017InventoryManipulationTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha1017-inventory-").toFile();
    ...
    void alphaInventoryManipulationPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha1017", "inventory_manipulation")
