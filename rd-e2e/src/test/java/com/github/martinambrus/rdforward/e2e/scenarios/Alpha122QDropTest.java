 ...
 * for Alpha 1.2.2b.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha122QDrop*"
 */
class Alpha122QDropTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha122-qdrop-").toFile();
    ...
    void alphaQDropPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha122", "q_drop")
