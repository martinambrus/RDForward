...
/**
 * Release 1.17: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release117ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release117-chat-test-").toFile();
    ...
    @Test
    void release117ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release117", "chat", 0.80)
