...
/**
 * Beta 1.5_01: verifies the spawn environment (survival mode, 1 cobblestone).
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta15EnvironmentCheckTest*"
 */
class Beta15EnvironmentCheckTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta15-environment-check-").toFile();
    ...
    void betaEnvironmentCheckPasses() throws Exception {
        ...
        Process client = launcher.launchBeta151(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta15", "environment_check")
