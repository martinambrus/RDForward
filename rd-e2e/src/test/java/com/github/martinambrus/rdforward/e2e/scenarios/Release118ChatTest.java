...
/**
 * Release 1.18: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release118ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release118-chat-test-").toFile();
    ...
    @Test
    void release118ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release118", "chat", 0.80)
