...
/**
 * Release 1.8.8: Tests walking to map edge, falling into void,
 * and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release188VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release188-void-fall-").toFile();
    ...
    @Test
    void release188VoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release188", "void_fall", 0.85)
