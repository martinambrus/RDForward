...
/**
 * Beta 1.3_01: tests walking to map edge, falling into void, and respawn teleport.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta13VoidFallTest*"
 */
class Beta13VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta13-void-fall-").toFile();
    ...
    void betaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta13", "void_fall", 0.85)
