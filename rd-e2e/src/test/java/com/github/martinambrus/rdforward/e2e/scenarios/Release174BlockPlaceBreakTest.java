...
/**
 * Release 1.7.4: Tests block breaking, placement, and creative mode replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release174BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release174-block-test-").toFile();
    ...
    @Test
    void release174BlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release174", "block_place_break")
