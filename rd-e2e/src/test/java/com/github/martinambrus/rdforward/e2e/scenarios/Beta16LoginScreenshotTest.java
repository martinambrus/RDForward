...
/**
 * Beta 1.6: logs into RDForward, loads the world, and captures a screenshot for baseline comparison.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta16LoginScreenshotTest*"
 */
class Beta16LoginScreenshotTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta16-world-loaded-").toFile();
    ...
    void betaClientLoadsWorldAndScreenshotMatchesBaseline() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta16", "world_loaded")
