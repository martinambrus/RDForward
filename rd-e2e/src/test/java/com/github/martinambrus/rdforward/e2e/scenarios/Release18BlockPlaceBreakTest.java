...
/**
 * Release 1.8: Tests block breaking, placement, and creative mode replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release18BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release18-block-test-").toFile();
    ...
    @Test
    void release18BlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release18", "block_place_break")
