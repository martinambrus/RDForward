 ...
 * for Alpha 1.1.0.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha110Column*"
 */
class Alpha110ColumnBuildTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha110-column-").toFile();
    ...
    void alphaColumnBuildAndBreakDown() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha110", "column_build")
