 ...
 * and confirming the server teleports back to spawn for Alpha 1.2.3_04.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Alpha123VoidFall*"
 */
class Alpha123VoidFallTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-alpha123-void-").toFile();
    ...
    void alphaVoidFallPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("alpha123", "void_fall", 0.85)
