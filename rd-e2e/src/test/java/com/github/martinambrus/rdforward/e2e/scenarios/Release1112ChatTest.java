...
/**
 * Release 1.11.2: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release1112ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release1112-chat-test-").toFile();
    ...
    @Test
    void release1112ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release1112", "chat", 0.80)
