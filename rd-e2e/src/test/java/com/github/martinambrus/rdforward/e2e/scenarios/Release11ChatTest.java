...
/**
 * Release 1.1: Tests sending and receiving chat messages.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release11ChatTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release11-chat-test-").toFile();
    ...
    @Test
    void release11ChatPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release11", "chat", 0.80)
