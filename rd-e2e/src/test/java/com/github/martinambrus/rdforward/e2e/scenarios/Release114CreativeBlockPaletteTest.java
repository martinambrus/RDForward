...
/**
 * Release 1.14: Creative block palette test. Opens creative inventory, grabs items from successive slots, places them in a row on the ground, and captures a screenshot.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e
 */
class Release114CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release114-palette-").toFile();
    ...
    @Test
    void release114CreativeBlockPalettePasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release114", "creative_block_palette")
