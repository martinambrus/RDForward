...
/**
 * Beta 1.6: tests block breaking, placement, and cobblestone replenishment.
 *
 * Run with: ./gradlew :rd-e2e:test -Pe2e --tests "*Beta16BlockPlaceBreakTest*"
 */
class Beta16BlockPlaceBreakTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-beta16-block-place-break-").toFile();
    ...
    void betaBlockPlaceBreakPasses() throws Exception {
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("beta16", "block_place_break")
