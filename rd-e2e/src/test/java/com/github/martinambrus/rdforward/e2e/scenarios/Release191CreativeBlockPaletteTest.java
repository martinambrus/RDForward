...
/**
 * Release 1.9.1: Creative block palette test.
 ...
 */
class Release191CreativeBlockPaletteTest {
    ...
    static void setUp() throws Exception {
        ...
        statusDir = Files.createTempDirectory("e2e-release191-palette-").toFile();
    ...
    @Test
    void release191CreativeBlockPalettePasses() throws Exception {
        String agentJar = findAgentJar();
        assertNotNull(agentJar, "rd-e2e-agent fat JAR not found. Run ./gradlew :rd-e2e-agent:fatJar first.");

        Process client = launcher.launchRelease191(agentJar, server.getPort(),
        ...
        try {
            ...
            new ScreenshotBaselineVerifier("release191", "creative_block_palette")
