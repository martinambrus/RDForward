...
/**
 * Field mappings for Release 1.4.6 (protocol v51).
 * Verified by CFR decompilation of the 1.4.6 client JAR.
 * dropOneItem is null - 1.4.6 uses f(boolean) instead of no-arg.
 */
public class ReleaseV51Mappings implements FieldMappings {
    ...
    @Override public String inventoryFieldName() { return "bJ"; }
    ...
    @Override public String guiScreenClassName() { return "aul"; }
    ...
    @Override public String forwardKeyFieldName() { return "E"; }
    @Override public String leftKeyFieldName() { return "F"; }
    @Override public String backKeyFieldName() { return "G"; }
    @Override public String rightKeyFieldName() { return "H"; }
    @Override public String jumpKeyFieldName() { return "I"; }
    @Override public String sneakKeyFieldName() { return "M"; }
    @Override public String creativeInventoryClassName() { return "avs"; }
    @Override public String guiInventoryClassName() { return "avz"; }
