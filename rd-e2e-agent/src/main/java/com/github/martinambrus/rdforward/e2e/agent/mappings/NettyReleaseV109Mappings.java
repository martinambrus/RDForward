...
/**
 * Field mappings for Release 1.9.2 (protocol v109).
 * Verified by CFR decompilation of the 1.9.2 client JAR.
 *
 * Minecraft = bcc, Entity = rr, EntityLivingBase = sa, EntityPlayer = zj,
 * AbstractClientPlayer = bmn, EntityPlayerSP = bmq,
 ...
 *
 * All obfuscated names identical to 1.9.1 (V108) - no mapping changes
 * in this bugfix release.
 */
public class NettyReleaseV109Mappings implements FieldMappings {
