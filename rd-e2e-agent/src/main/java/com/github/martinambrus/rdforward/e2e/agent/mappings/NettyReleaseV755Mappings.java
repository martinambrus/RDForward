...
public class NettyReleaseV755Mappings implements FieldMappings {
    ...
    @Override public String rightClickMethodName() { return "aP"; } // dvo.aP() right-click/startUseItem (Mojang mapping 1.17)
    ...
    @Override public String smartCullFieldName() { return "E"; } // public boolean smartCull on dvo; used in LevelRenderer BFS
}
