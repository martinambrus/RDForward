...
/**
 * Field mappings for Release 1.20.2 (protocol v764).
 * Derived from Fabric Yarn + Intermediary mappings.
 */
public class NettyReleaseV764Mappings implements FieldMappings {

    @Override public String minecraftClassName() { return "eqv"; }
    ...
    @Override public String inventoryFieldName() { return "cn"; }
    ...
    @Override public String guiScreenClassName() { return "eyk"; }
    ...
    @Override public String creativeInventoryClassName() { return "ezw"; }
    @Override public String guiInventoryClassName() { return "fah"; }
    ...
    @Override public String blockRenderDispatcherClassName() { return "foy"; }
    @Override public String renderMethodName() { return "d"; }
    @Override public String gameRendererClassName() { return "fnx"; }
    @Override public String smartCullFieldName() { return "D"; } // public boolean smartCull on eqv
}
