...
/**
 * Field mappings for Release 1.14.1 (protocol v480).
 * Verified by CFR decompilation of the 1.14.1 client JAR.
 *
 ...
 * Block = bmn, World = bhi, ClientWorld = dhn,
 ...
 * - Minecraft class renamed: cvi -> cvk. Session: cvt -> cvv. Window: cub -> cud.
 * - GameSettings: cvm -> cvo. MouseHelper: cvj -> cvl. KeyBinding: cvf -> cvh.
 * - Entity: aif -> aii. LivingEntity: aio -> air. PlayerEntity: avx -> avy.
 * - ClientPlayerEntity: djv -> djx. MovementInput: djt -> djv.
 * - IngameGui: cwb -> cwd. NewChatGui: cwp -> cwr. ChatLine: cvd -> cvf.
 * - PlayerController: dhk -> dhm. Screen: czr -> czt. Item: bbv -> bbw.
 * - PlayerInventory: avw -> avx.
 * - tick method shifted: n -> m. click method shifted: e -> f.
 * - CreativeInventoryScreen: day -> dba. InventoryScreen: dbh -> dbj.
 * - All field names within classes remain the same as V477.
 */
public class NettyReleaseV480Mappings implements FieldMappings {
    ...
    @Override public String tickMethodName() { return "m"; } // cvk.m() game tick; decrements s, ticks screens
    ...
    @Override public String itemIdFieldName() { return "f"; } // bbw (Item) on bcb (ItemStack)
    ...
    @Override public String guiScreenWidthFieldName() { return "width"; } // int on czt (Screen); un-obfuscated in 1.14.1
    @Override public String guiScreenHeightFieldName() { return "height"; } // int on czt (Screen); un-obfuscated in 1.14.1
    ...
    @Override public String rightClickMethodName() { return "aF"; } // cvk.aF() right-click/startUseItem (verified by CFR decompilation)
