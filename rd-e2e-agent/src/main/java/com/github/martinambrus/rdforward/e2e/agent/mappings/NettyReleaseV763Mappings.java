...
/**
 * Field mappings for Release 1.20/1.20.1 (protocol v763).
 * Derived from Fabric Yarn + Intermediary mappings.
 */
public class NettyReleaseV763Mappings implements FieldMappings {

    @Override public String minecraftClassName() { return "enn"; }
    ...
    @Override public String posXFieldName() { return "J"; }
    @Override public String posYFieldName() { return "K"; }
    @Override public String posZFieldName() { return "L"; }
    @Override public String gameSettingsFieldName() { return "m"; }
    @Override public String movementInputFieldName() { return "cm"; }
    ...
    @Override public String inventoryFieldName() { return "cl"; }
    ...
    @Override public String networkHandlerFieldName() { return "cl"; }
    ...
    @Override public String guiScreenClassName() { return "euq"; }
    ...
    @Override public String creativeInventoryClassName() { return "ewd"; }
    @Override public String guiInventoryClassName() { return "ewo"; }
    @Override public String closeContainerMethodName() { return "q"; }
    @Override public boolean posYIsFeetLevel() { return true; }
    @Override public String rightClickMethodName() { return "bs"; }
    @Override public boolean isLwjgl3() { return true; }
    @Override public boolean isNettyClient() { return true; }
    @Override public String blockRenderDispatcherClassName() { return "fko"; }
    @Override public String renderMethodName() { return "f"; }
    @Override public String gameRendererClassName() { return "fjq"; }
    @Override public String smartCullFieldName() { return "E"; } // public boolean smartCull on enn
}
