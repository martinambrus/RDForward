...
public class NettyReleaseV758Mappings implements FieldMappings {
    ...
    @Override public String rightClickMethodName() { return "aP"; } // dyr.aP() right-click/startUseItem (Mojang mapping 1.18.2)
    ...
    @Override public String smartCullFieldName() { return "D"; } // public boolean smartCull on dyr
}
