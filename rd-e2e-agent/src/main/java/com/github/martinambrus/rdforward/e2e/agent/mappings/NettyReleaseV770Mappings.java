...
/**
 * Field mappings for Release 1.21.5 (protocol v770).
 * Derived from Fabric Yarn + Intermediary mappings.
 */
public class NettyReleaseV770Mappings implements FieldMappings {

    @Override public String minecraftClassName() { return "fqq"; }
    ...
    @Override public String onGroundFieldName() { return "aH"; }
    @Override public String inventoryFieldName() { return "ct"; }
    ...
    @Override public String guiScreenClassName() { return "fzq"; }
    ...
    @Override public String creativeInventoryClassName() { return "gav"; }
    @Override public String guiInventoryClassName() { return "gbg"; }
    @Override public String closeContainerMethodName() { return "o"; }
    ...
    @Override public String blockRenderDispatcherClassName() { return "gsq"; }
    @Override public String renderMethodName() { return "c"; }
    @Override public String gameRendererClassName() { return "grd"; }
    @Override public String smartCullFieldName() { return "E"; } // public boolean smartCull on fqq
}
