...
/**
 * Field mappings for Release 1.21.2/1.21.3 (protocol v768).
 * Derived from Fabric Yarn + Intermediary mappings.
 */
public class NettyReleaseV768Mappings implements FieldMappings {

    @Override public String minecraftClassName() { return "fmf"; }
    ...
    @Override public String movementInputFieldName() { return "j"; }
    ...
    @Override public String itemIdFieldName() { return "o"; }
    @Override public String stackSizeFieldName() { return "m"; }
    ...
    @Override public String networkHandlerFieldName() { return "i"; }
    ...
    @Override public String guiScreenClassName() { return "ftx"; }
    @Override public String sessionFieldName() { return "Y"; }
    ...
    @Override public String creativeInventoryClassName() { return "fvc"; }
    @Override public String guiInventoryClassName() { return "fvn"; }
    ...
    @Override public String blockRenderDispatcherClassName() { return "gmn"; }
    @Override public String renderMethodName() { return "c"; }
    @Override public String gameRendererClassName() { return "gla"; }
    @Override public String smartCullFieldName() { return "E"; } // public boolean smartCull on fmf
}
