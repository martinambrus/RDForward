...
/**
 * Field mappings for Release 1.21.8 (protocol v772).
 * Derived from Fabric Yarn + Intermediary mappings.
 */
public class NettyReleaseV772Mappings implements FieldMappings {

    @Override public String minecraftClassName() { return "fue"; }
    ...
    @Override public String guiScreenClassName() { return "get"; }
    ...
    @Override public String creativeInventoryClassName() { return "ggq"; }
    @Override public String guiInventoryClassName() { return "ghb"; }
    ...
    @Override public String blockRenderDispatcherClassName() { return "gys"; }
    @Override public String renderMethodName() { return "c"; }
    @Override public String gameRendererClassName() { return "gxb"; }
    @Override public String smartCullFieldName() { return "E"; } // public boolean smartCull on fue
}
