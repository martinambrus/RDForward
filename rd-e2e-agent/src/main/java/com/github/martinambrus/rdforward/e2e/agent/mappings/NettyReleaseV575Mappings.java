...
/**
 * Field mappings for Release 1.15.1 (protocol v575).
 * Verified by CFR decompilation of the 1.15.1 client JAR.
 *
 ...
 * - PlayerController field on Minecraft changed from field to p (dno).
 ...
 * - Window framebuffer fields shifted: width q, height r (was r, s).
 ...
 */
public class NettyReleaseV575Mappings implements FieldMappings {
    ...
    @Override public String guiScreenWidthFieldName() { return "width"; } // int on dfz (Screen); un-obfuscated in 1.15.1
    @Override public String guiScreenHeightFieldName() { return "height"; } // int on dfz (Screen); un-obfuscated in 1.15.1
    ...
    @Override public String rightClickMethodName() { return "aE"; } // dbl.aE() right-click/startUseItem (Mojang mapping)
