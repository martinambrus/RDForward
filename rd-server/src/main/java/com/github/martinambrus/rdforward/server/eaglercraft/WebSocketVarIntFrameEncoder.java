...
/**
 * Combined VarInt frame encoder + WebSocket frame wrapper for EaglerCraft clients.
 *
 ...
 * and {@link ByteBufToWebSocketFrame} in the EaglerCraft pipeline. The regular VarIntFrameEncoder
