...
/**
 * Minimal in-memory {@code Server} for the NeoForge bridge tests. Only the
 * pieces the bridge touches are implemented.
 */
public final class NeoForgeTestServer implements Server {
