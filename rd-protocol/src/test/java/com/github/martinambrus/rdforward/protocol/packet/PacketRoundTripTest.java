...
class PacketRoundTripTest {
    ...
    @Test
    void v3v4v5AndV6ShareSamePacketRegistrations() {
        // Post-rewrite Alpha v3, v4, v5 and v6 use identical wire formats
        ProtocolVersion[] postRewriteVersions = {ProtocolVersion.ALPHA_1_2_0, ProtocolVersion.ALPHA_1_2_2, ProtocolVersion.ALPHA_1_2_3, ProtocolVersion.ALPHA_1_2_5};
