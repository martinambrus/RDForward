...
/**
 * 1.20 Play state, S2C packet 0x6E: Update Tags.
 *
 * Changes from V762:
 * - Block tags REMOVED (1): replaceable_plants
 * - Block tags ADDED (17): bamboo_blocks, cherry_logs, all_hanging_signs,
 *   ceiling_hanging_signs, wall_hanging_signs, combination_step_sound_blocks,
 *   enchantment_power_provider, enchantment_power_transmitter, maintains_farmland,
 *   replaceable, replaceable_by_trees, sniffer_diggable_block, sniffer_egg_hatch_boost,
 *   stone_buttons, sword_efficient, trail_ruins_replaceable, vibration_resonators
 * - Net block tags: 129 - 1 + 17 = 145
 * - Item tags ADDED (12): bamboo_blocks, cherry_logs, breaks_decorated_pots,
 *   decorated_pot_ingredients, decorated_pot_sherds, noteblock_top_instruments,
 *   sniffer_food, stone_buttons, trim_materials, trim_templates, trimmable_armor,
 *   villager_plantable_seeds
 * - Net item tags: 66 + 12 = 78
 * - Entity type, fluid, game event, damage type tags: unchanged from V762.
 */
public class UpdateTagsPacketV763 implements Packet {

    public static final UpdateTagsPacketV763 INSTANCE = new UpdateTagsPacketV763();
    ...
    private static void serializePayload(ByteBuf buf) {
        ...
        // 6. Damage type tags (unchanged from V762)
