...
/**
 * 1.20.3 Configuration/Play state, S2C packet.
 * Configuration: 0x09, Play: 0x74.
 *
 * Changes from V764:
 * - Entity type tags ADDED (6): can_breathe_under_water, undead, zombies,
 *   can_turn_in_boats, deflects_arrows, deflects_tridents -> 20 total
 * - Damage type tags ADDED (1): can_break_armor_stand -> 25 total
 * - Block tags: 147 (unchanged from V764)
 * - Item tags: 78 (unchanged from V764)
 * - Fluid tags: 2 (unchanged)
 * - Game event tags: 5 (unchanged from V764)
 */
public class UpdateTagsPacketV765 implements Packet {

    public static final UpdateTagsPacketV765 INSTANCE = new UpdateTagsPacketV765();
    ...
    @Override
    public int getPacketId() { return 0x74; }
    ...
    private static void serializePayload(ByteBuf buf) {
        ...
        // 6. Damage type tags (25, +1 from V764)
