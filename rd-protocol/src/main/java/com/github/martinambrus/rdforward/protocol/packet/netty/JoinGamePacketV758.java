...
/**
 * 1.18.2 Play state, S2C packet 0x26: Join Game.
 *
 * Same as V757 but infiniburn fields gain a '#' prefix (tag reference format).
 */
public class JoinGamePacketV758 implements Packet {
    ...
    public JoinGamePacketV758() {}

    public JoinGamePacketV758(int entityId, int gameMode, int maxPlayers,
