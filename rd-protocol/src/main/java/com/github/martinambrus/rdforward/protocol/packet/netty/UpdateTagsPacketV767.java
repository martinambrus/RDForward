 ...
 *
 * Changes from V766:
 * - NEW registry: minecraft:enchantment (22 tags)
 * - Block tags ADDED (1): blocks_wind_charge_explosions -> 149 total
 * - Entity type tags ADDED (4): deflects_projectiles, immune_to_infested,
 *   immune_to_oozing, no_anger_from_wind_charge -> 24 total
 *   (V766's 20 tags kept for safety — extra tags are harmless)
 * - Damage type tags ADDED (1): wind_charge -> 26 total
 * - Item tags: unchanged from V766 (78)
 * - Fluid tags: unchanged (2)
...
public class UpdateTagsPacketV767 implements Packet {
    ...
    public void write(ByteBuf buf) {
        ...
        // 1. Block tags (149 = V766's 148 + blocks_wind_charge_explosions)
        McDataTypes.writeVarIntString(buf, "minecraft:block");
        writeEmptyTags(buf, BLOCK_TAGS);

        // 2. Item tags (78, unchanged from V766)
