...
/**
 * 1.18 Play state, S2C packet 0x67: Update Tags.
 *
 * Same registry-based format as V755, but with tag changes:
 * - Block: 14 new tags, 1 rename (lava_pool_stone_replaceables -> lava_pool_stone_cannot_replace)
 * - Item: 2 new tags (dirt, terracotta)
 * - Fluid/entity_type/game_event: unchanged from V755
 */
public class UpdateTagsPacketV757 implements Packet {

    public static final UpdateTagsPacketV757 INSTANCE = new UpdateTagsPacketV757();
    ...
    private static void serializePayload(ByteBuf buf) {
        ...
        // 5. Game event tags (same as 1.17)
