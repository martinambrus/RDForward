 ...
 *
 * Compared to v735:
 * - 3 new block tags: base_stone_nether, base_stone_overworld, mushroom_grow_block (83 -> 86)
...
public class UpdateTagsPacketV751 implements Packet {
    ...
    private static final String[] BLOCK_TAGS = {
        ...
        "minecraft:logs", "minecraft:logs_that_burn", "minecraft:mushroom_grow_block",
    ...
    private static final String[] ITEM_TAGS = {
        ...
        "minecraft:gold_ores", "minecraft:jungle_logs",
