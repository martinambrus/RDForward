...
/**
 * 1.17 Play state, S2C packet 0x26: Join Game.
 *
 * Same as V751 but dimension type compounds gain min_y (Int) and height (Int) fields.
 * World height stays at 0-255 in 1.17 (extended height was pushed to 1.18).
 */
public class JoinGamePacketV755 implements Packet {
    ...
    public JoinGamePacketV755() {}

    public JoinGamePacketV755(int entityId, int gameMode, int maxPlayers, int viewDistance) {
