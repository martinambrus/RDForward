...
/**
 * 1.19.3 Play state, S2C packet 0x6A: Update Tags.
 *
 * Changes from V759:
 * - Block tags added (2): all_signs, invalid_spawn_inside
 * - Block tags removed (1): non_flammable_wood
 * - Item tags added (2): creeper_igniters, fence_gates
 * - Item tags removed (1): overworld_natural_logs
 * - Entity type tags, fluid tags, game event tags: unchanged from V759.
 * Total block tags: 128. Total item tags: 59.
 */
public class UpdateTagsPacketV761 implements Packet {

    public static final UpdateTagsPacketV761 INSTANCE = new UpdateTagsPacketV761();
    ...
    @Override
    public int getPacketId() { return 0x6A; }
