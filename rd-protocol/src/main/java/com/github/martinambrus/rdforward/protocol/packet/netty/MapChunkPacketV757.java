...
/**
 * 1.18 Play state, S2C packet 0x22: Chunk Data and Update Light (combined).
 *
 * In 1.18, the Chunk Data and Update Light packets are merged into a single packet.
 * No primaryBitMask (all 16 sections must be present). Biomes are per-section
 * paletted containers inside the section data (not a top-level field).
 *
 * Wire format:
 *   [int]       chunkX
 *   [int]       chunkZ
 ...
 */
public class MapChunkPacketV757 implements Packet {
    ...
    public MapChunkPacketV757() {}

    public MapChunkPacketV757(int chunkX, int chunkZ,
    ...
    public void write(ByteBuf buf) {
        ...
        // Light data (embedded — no separate UpdateLight packet)
