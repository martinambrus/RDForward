...
/**
 * 1.20.5 Configuration/Play state, S2C packet.
 * Configuration: 0x0D, Play: 0x78.
 *
 * Changes from V765:
 * - Block tags ADDED (1): badlands_terracotta -> 148 total
 * - Item tags: axolotl_tempt_items RENAMED to axolotl_food,
 *   tools REMOVED, enchantable/mace ADDED -> 78 total
 * - Entity type tags: 20 (unchanged from V765)
 * - Damage type tags: 25 (unchanged from V765)
 * - Fluid tags: 2 (unchanged)
 * - Game event tags: 5 (unchanged)
 */
public class UpdateTagsPacketV766 implements Packet {

    public static final UpdateTagsPacketV766 INSTANCE = new UpdateTagsPacketV766();
    ...
    private static final String[] ENTITY_TYPE_TAGS = {
        ...
        "minecraft:deflects_arrows",
        "minecraft:deflects_tridents",
    ...
    private static void serializePayload(ByteBuf buf) {
        ...
        // 1. Block tags (148 = V765's 147 + badlands_terracotta)
        McDataTypes.writeVarIntString(buf, "minecraft:block");
        writeEmptyTags(buf, BLOCK_TAGS);

        // 2. Item tags (78 = V765's 78 - tools - axolotl_tempt_items + axolotl_food + enchantable/mace)
        ...
        // 6. Damage type tags (25, unchanged from V765)
