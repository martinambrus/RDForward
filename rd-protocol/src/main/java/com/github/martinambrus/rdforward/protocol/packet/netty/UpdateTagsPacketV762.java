 ...
 *
 * Changes from V761:
 * - 6 registries (was 5): +minecraft:damage_type (24 tags)
 * - Block tags: +smelts_to_glass (128 -> 129)
 * - Item tags: +axes, hoes, pickaxes, shovels, swords, smelts_to_glass, tools (59 -> 66)
 * - Entity type tags: +dismounts_underwater, fall_damage_immune (11 -> 13)
...
public class UpdateTagsPacketV762 implements Packet {
    ...
    public void write(ByteBuf buf) {
        ...
        // 6. Damage type tags (NEW in 1.19.4)
