...
/**
 * 1.21.2 Login state, S2C packet 0x02: Login Success.
 *
 * Same as V766 but WITHOUT the strictErrorHandling boolean.
 *
 * Wire format:
 ...
 */
public class LoginSuccessPacketV768 implements Packet {

    private long uuidMsb;
    private long uuidLsb;
    private String username;

    public LoginSuccessPacketV768() {}

    public LoginSuccessPacketV768(String uuid, String username) {
