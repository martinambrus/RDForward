...
/**
 * 1.21.5 Play state, S2C packet 0x01: Spawn Entity.
 *
 * Same wire format as V769 but entityType IDs shifted due to lingering_potion
 * insertion at entity type 100 (all entities after shift +1).
 * Player entity type: 148 (was 147 in v769).
 */
public class NettySpawnEntityPacketV770 implements Packet {

    private static final int ENTITY_TYPE_PLAYER = 148;
    ...
    public NettySpawnEntityPacketV770() {}

    public NettySpawnEntityPacketV770(int entityId, String uuidStr,
