...
/**
 * 1.21.6 Play state, S2C packet 0x01: Spawn Entity.
 *
 * Same wire format as V770 but entityType IDs shifted due to happy_ghast
 * insertion at entity type 56 (all entities from 56 onward shift +1).
 * Player entity type: 149 (was 148 in v770).
 */
public class NettySpawnEntityPacketV771 implements Packet {

    private static final int ENTITY_TYPE_PLAYER = 149;
    ...
    public NettySpawnEntityPacketV771() {}

    public NettySpawnEntityPacketV771(int entityId, String uuidStr,
