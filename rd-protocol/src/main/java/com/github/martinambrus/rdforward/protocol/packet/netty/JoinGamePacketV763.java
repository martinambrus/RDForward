...
/**
 * 1.20 Play state, S2C packet 0x28: Join Game.
 *
 * Changes from V762:
 * - New VarInt portalCooldown appended after lastDeathLocation boolean.
 * - All other fields identical to V762.
 */
public class JoinGamePacketV763 implements Packet {
    ...
    public JoinGamePacketV763() {}

    public JoinGamePacketV763(int entityId, int gameMode, int maxPlayers,
    ...
    private void writeDimensionCodec(ByteBuf buf) {
        ...
        // minecraft:dimension_type registry (identical to V762)
        ...
        // minecraft:worldgen/biome registry (same as V762 — has_precipitation Byte)
        ...
        // minecraft:chat_type registry (7 entries, same as V762)
        ...
        // minecraft:damage_type registry (44 entries, same as V762)
    ...
    // ========================================================================
    // Chat type entry writer (same as V762)
    // ========================================================================
