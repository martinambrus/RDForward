...
/**
 * 1.20.2 Configuration/Play state, S2C packet.
 * Configuration: 0x08, Play: 0x70.
 *
 * Changes from V763:
 * - Block tags ADDED (2): camel_sand_step_sound_blocks, concrete_powder -> 147 total
 * - Item tags: 78 (unchanged)
 * - Entity type tags ADDED (1): non_controlling_rider -> 14 total
 * - Game event tags: entity_roar/entity_shake replaced by entity_action/unequip
 * - Damage type tags: 24 (unchanged)
 * - Fluid tags: 2 (unchanged)
 */
public class UpdateTagsPacketV764 implements Packet {

    public static final UpdateTagsPacketV764 INSTANCE = new UpdateTagsPacketV764();
    ...
    @Override
    public int getPacketId() { return 0x70; }
    ...
    private static void serializePayload(ByteBuf buf) {
        ...
        // 2. Item tags (78, unchanged from V763)
        ...
        // 4. Entity type tags (14, +1 non_controlling_rider)
        McDataTypes.writeVarIntString(buf, "minecraft:entity_type");
        writeEmptyTags(buf, ENTITY_TYPE_TAGS);

        // 5. Game event tags (entity_roar/entity_shake replaced by entity_action/unequip)
        ...
        // 6. Damage type tags (24, unchanged)
