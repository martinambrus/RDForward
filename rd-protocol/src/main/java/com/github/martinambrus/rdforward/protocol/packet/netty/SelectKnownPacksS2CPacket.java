...
public class SelectKnownPacksS2CPacket implements Packet {
    ...
    public void write(ByteBuf buf) {
        McDataTypes.writeVarInt(buf, 15); // 15 packs
        ...
        // Pack 8: minecraft core 1.21.5
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.5");

        // Pack 9: minecraft core 1.21.6
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.6");

        // Pack 10: minecraft core 1.21.7
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.7");

        // Pack 11: minecraft core 1.21.8
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.8");

        // Pack 12: minecraft core 1.21.9
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.9");

        // Pack 13: minecraft core 1.21.10
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.10");

        // Pack 14: minecraft core 1.21.11
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
        McDataTypes.writeVarIntString(buf, "1.21.11");

        // Pack 15: minecraft core 26.1
        McDataTypes.writeVarIntString(buf, "minecraft");
        McDataTypes.writeVarIntString(buf, "core");
