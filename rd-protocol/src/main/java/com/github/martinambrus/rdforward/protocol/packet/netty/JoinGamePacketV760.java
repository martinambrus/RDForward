...
/**
 * 1.19.1 Play state, S2C packet 0x25: Join Game.
 *
 * Changes from V759:
 * - Chat type registry expanded from 1 entry to 7 entries.
 * - Parameter name "team_name" renamed to "target".
 * - msg_command_incoming/outgoing have style: {color: "gray", italic: 1}.
 * - Dimension type and biome registries are identical to V759.
 */
public class JoinGamePacketV760 implements Packet {
    ...
    public JoinGamePacketV760() {}

    public JoinGamePacketV760(int entityId, int gameMode, int maxPlayers,
    ...
    public void write(ByteBuf buf) {
        ...
        // dimensionType: String identifier (same as V759)
        McDataTypes.writeVarIntString(buf, "minecraft:overworld");
    ...
    private void writeDimensionCodec(ByteBuf buf) {
        ...
        // minecraft:dimension_type registry (identical to V759)
        ...
        // minecraft:worldgen/biome registry (identical to V759)
        ...
        // minecraft:chat_type registry (7 entries for 1.19.1)
