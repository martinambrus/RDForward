...
/**
 * 1.18 Play state, S2C packet 0x26: Join Game.
 *
 * Same as V755 but adds VarInt simulationDistance after viewDistance.
 */
public class JoinGamePacketV757 implements Packet {
    ...
    public JoinGamePacketV757() {}

    public JoinGamePacketV757(int entityId, int gameMode, int maxPlayers,
