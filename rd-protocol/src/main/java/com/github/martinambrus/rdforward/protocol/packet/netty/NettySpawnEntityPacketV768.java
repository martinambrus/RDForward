...
/**
 * 1.21.2 Play state, S2C packet 0x01: Spawn Entity.
 *
 * Same wire format as V766 but entityType IDs shifted due to 20 new entities
 * (boats split per wood type, creaking entities, etc.).
 * Player entity type: 148 (was 128 in v766).
 */
public class NettySpawnEntityPacketV768 implements Packet {
    ...
    public NettySpawnEntityPacketV768() {}

    public NettySpawnEntityPacketV768(int entityId, String uuidStr,
