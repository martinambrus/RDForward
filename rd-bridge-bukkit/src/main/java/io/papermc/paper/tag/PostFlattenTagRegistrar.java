...
public interface PostFlattenTagRegistrar extends io.papermc.paper.plugin.lifecycle.event.registrar.Registrar {
    ...
    java.util.Collection getTag(io.papermc.paper.registry.tag.TagKey arg0);
